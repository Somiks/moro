            ...
            {t('role')}
                    ...
                    <div className="space-y-6">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-4 text-gray-800 hover:text-blue-600 transition-colors group"
                        >
                            <div className="bg-blue-100 p-3 rounded-full group-hover:bg-blue-600 group-hover:text-white transition-all">
